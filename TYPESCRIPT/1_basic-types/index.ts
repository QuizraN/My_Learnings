...
export default (() => {
  ...
  //or
  let pi1:unknown = '3.14159';
  let tau1 = <number>pi1 * 2;

  console.log('[Exercise 1.1]', `${tau1} is ${pi1} times two.`);
  ...
  let [name, qty] = inventoryItem;

  const msg = addInventory(name as string, <number>qty);
